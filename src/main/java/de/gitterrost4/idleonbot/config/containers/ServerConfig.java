...
public class ServerConfig extends de.gitterrost4.botlib.config.containers.ServerConfig {
  ...
  public String toString() {
    return "ServerConfig [recipeConfig=" + recipeConfig + ", wikiConfig=" + wikiConfig + ", getSuperUserRoles()="
        + getSuperUserRoles() + ", getName()=" + getName() + ", getServerId()=" + getServerId() + ", getBotPrefixes()="
        + getBotPrefixes() + ", getDatabaseFileName()=" + getDatabaseFileName() + ", getHelpConfig()=" + getHelpConfig()
        + "]";
  }
